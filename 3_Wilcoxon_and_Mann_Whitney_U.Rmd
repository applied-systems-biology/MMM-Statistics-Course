...
Generate some paired data, you can either use the example from the paired t-test or do your own data. Experiment with the data to answer the following questions:
...
```{r paired data Wilcoxon, echo = TRUE, message=FALSE}
  set.seed(123)
  n = 3
  # Add code here to create samples, run the significance tests and possibly visualize the smaples
```
