...
Now try the same thing with salary as the outcome variable. Which is the best model according to AIC? Does that mean that the variables in that model are the only significant varaibles that affect the salary?
